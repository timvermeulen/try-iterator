...
impl<I> ExactSizeTryIterator for RevMut<'_, I> where I: DoubleEndedTryIterator + ExactSizeTryIterator
{}

impl<I> FusedTryIterator for RevMut<'_, I> where I: DoubleEndedTryIterator + FusedTryIterator {}
